...
const PaymentPage: React.FC = () => {
  ...
  const handleDeliveryChange = (prop: keyof DeliveryType) => (
    e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement> | DeliveryMethodType | string | boolean
  ) => {
    if (e)
      setDelivery({
        ...delivery,
        [prop]: typeof e !== 'string' ? (typeof e !== 'boolean' ? e.target.value : Boolean(e)) : String(e),
      })
  }
  ...
  if (!cart.length) history.replace('/cart')
